...
print('Training...')
print('RMS Error (aapl):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (aapl):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.title('Prediction - AAPL (Training)')
plt.legend()

print('Testing...')
print('RMS Error aapl):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (aapl):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - AAPL (Testing)')
plt.legend()
plt.show()
...
print('Training...')
print('RMS Error (googl):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (googl):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - GOOGL (Training)')
plt.legend()

print('Testing...')
print('RMS Error (googl):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (googl):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - GOOGL (Testing)')
plt.legend()
plt.show()
...
print('Training...')
print('RMS Error (kse):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (kse):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - KSE (Training)')
plt.legend()

print('Testing...')
print('RMS Error (kse):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (kse):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - KSE (Testing)')
plt.legend()
plt.show()