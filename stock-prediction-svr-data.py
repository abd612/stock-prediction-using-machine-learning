...
print('Training...')
print('RMS Error (1 year data):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (1 year data):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.title('Prediction - 1 year data (Training)')
plt.legend()

print('Testing...')
print('RMS Error (1 year data):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (1 year data):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - 1 year data (Testing)')
plt.legend()
plt.show()
...
print('Training...')
print('RMS Error (5 year data):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (5 year data):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - 5 year data (Training)')
plt.legend()

print('Testing...')
print('RMS Error (5 year data):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (5 year data):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - 5 year data (Testing)')
plt.legend()
plt.show()
...
print('Training...')
print('RMS Error (38 year data):', sqrt(mean_squared_error(total_closes_train, total_trained_closes_rbf)))
print('R2 Score (38 year data):', r2_score(total_closes_train, total_trained_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - 38 year data (Training)')
plt.legend()

print('Testing...')
print('RMS Error (38 year data):', sqrt(mean_squared_error(total_closes_test, total_tested_closes_rbf)))
print('R2 Score (38 year data):', r2_score(total_closes_test, total_tested_closes_rbf))
...
plt.xlabel('Date (Normalized)')
plt.ylabel('Close (Normalized)')
plt.title('Prediction - 38 year data (Testing)')
plt.legend()
plt.show()